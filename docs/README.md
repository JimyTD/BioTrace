...
| 加套册 / 加皮肤 / 出安卓包 / 管后台 / 护栏 / 共享旅途 / 宠物图鉴 | [`features/`](./features/) |
...
| [`features/宠物图鉴.md`](./features/宠物图鉴.md) | 驯养分轨、品种格、名录豁免与引入按种 |
...
| 文件 | 内容 |
|------|------|
| [`wip/品种格呈现.md`](./wip/品种格呈现.md) | 宠物卡品种格怎么呈现（全库灰格已否决；当前权宜只亮已点亮） |
| [`wip/物种树-结构议题.md`](./wip/物种树-结构议题.md) | 物种树结构决策（分层折中已拍板；未决主要是大扇出）；**讨论中，非 SPEC** |
